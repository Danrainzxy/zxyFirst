...
typedef enum
{
    FGalleryShowTypeWithText = 1,
    FGalleryShowTypeNone
} FGalleryShowType;
...
@property (nonatomic,retain) UILabel *picDescLabel;
@property (nonatomic,assign) FGalleryShowType showType;
@end
...
- (NSString *)photoGallery:(FGalleryViewController*)gallery textAtIndex:(NSUInteger)index;
